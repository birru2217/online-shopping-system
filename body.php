  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="img/gat12111.jpg" alt="Los Angeles" style="width:100% hight=20px margin: auto;;" >
                        ...
                        echo "
								...
								<div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>$pro_price<del class='product-old-price'>ETB990.00</del></h4>
							...
							<div id="get_product_home2">
								...
								<div class="product-widget">
									...
									<div class="product-body">
										...
										<h4 class="product-price">ETB980.00 <del class="product-old-price">ETB990.00</del></h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
										<h4 class="product-price">ETB980.00 <del class="product-old-price">ETBS990.00</del></h4>
									</div>
								</div>
								<!-- /product widget -->
